...
function wp_render_background_support( $block_content, $block ) {
	...
	$background_styles['backgroundImage']      = isset( $block_attributes['style']['background']['backgroundImage'] ) ? $block_attributes['style']['background']['backgroundImage'] : null;
	$background_styles['backgroundSize']       = isset( $block_attributes['style']['background']['backgroundSize'] ) ? $block_attributes['style']['background']['backgroundSize'] : null;
	...
	if ( ! empty( $background_styles['backgroundImage'] ) ) {
		$background_styles['backgroundSize'] = isset( $background_styles['backgroundSize'] ) ? $background_styles['backgroundSize'] : 'cover';
