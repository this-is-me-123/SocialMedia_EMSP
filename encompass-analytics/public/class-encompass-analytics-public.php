...
class Encompass_MSP_Analytics_Public {
    ...
    public function __construct(string $plugin_name, string $version) {
        ...
        // Defer admin user tracking check to 'init' action
        add_action('init', array($this, 'maybe_disable_tracking_for_admin'));

        
        // Defer tracking settings initialization to 'init' action
    ...
    /**
     * Initialize tracking settings after WordPress is fully loaded.
     */
    /**
     * Disable tracking for admin users after WordPress is fully loaded.
     */
    ...
    public function initialize_tracking_settings() {
